...
- [x] Entferne in /public alle Elemnte, die nicht gebraucht werden. Aber immer Doppelchecken!

## Piece Editor
- [x] Implement save to database, see PieceEditorSidebar.tsx, Line 19!

## History Mode
- [x] Often, the History Mode just doesn't work, jumping right to the first move.
- [x] Add move highlighting in History Mode.
...
- [x] Seite soll SEO-optimiert sein, Canonical auf https://chesspie.de/editor/board/faq
