...
export function Header() {
    ...
    return (
        <header className={`bg-amber-100 flex justify-between lg:px-5`}>
            <Link href="/" className={`${bungee.className} text-amber-400 [font-variant-caps:small-caps] ml-1.5 lg:ml-0 ${small?"text-3xl lg:text-6xl":"text-4xl lg:text-7xl"} caret-transparent`}>ChessPie</Link>
